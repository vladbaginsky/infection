...
class Inf:
    ...
    def create_mobs(self):
        for i in range(self.amount):
            a = Mob(self.r, self.screen, randint(0, self.WIDTH), randint(0, self.HEIGHT))
            self.pers.append(a)
    ...
    def options_window(self,):
        ...
        while not stop:
            ...
            self.button( 'Количество ' + str(self.amount), 4,
                        (180, 0, 0), (10, 80))
            self.button( 'Радиус инфицирования ' + str(self.rinf),
                        4, (180, 0, 0), (10, 110))
            self.button(
    ...
    def finish_window(self, screen):
        ...
        while not stop:
            ...
            self.button('Заново ',
                        4, (180, 0, 0), (470, 400))
            if self.time == 0:
                self.button('Вирус убил первого своего носителя, никого не заразив ',
                            1, (210, 0, 0), (10, 110))
